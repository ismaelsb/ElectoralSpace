...
el hiperplano cuya suma de coordenadas es 1. La imagen de la proyección es un triángulo equilátero. De la misma manera podemos representar 2 valores en un segmento o 4 valores en un tetraedro.
