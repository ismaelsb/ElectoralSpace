...
Let's represent in the next diagramns the theoretical borders for the regions. the red points are on the discrete lattice s+1 while the black ones are on the discrete lattice s+2. The borders are the result of the superposition of both lattices.
...
![](ElectoralSpace_files/figure-html/unnamed-chunk-42-1.png) ![](ElectoralSpace_files/figure-html/unnamed-chunk-42-2.png) 
