...
Utilizamos una función de asignación electoral para distintos métodos proporcionales de cocientes con la posibilidad de añadir un umbral de entrada. Se pueden mostrar los efectos del umbral electoral sobre las regiones de asignación en un diagrama.
